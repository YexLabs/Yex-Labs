...
export default function ILOCard_Content({ token }) {
  ...
  const deposit = async () => {
    ...
    try {
      if (formatEther(allownedTokenToFTO || 0) == "0") {
    ...
    <div className="flex-col mt-8">
          ...
          <div className="flex-col">
            <div className="flex justify-between">
              ...
              <div className="flex bg-white rounded-full shadow-lg items-center px-3 hover:cursor-pointer hover:bg-opacity-0">
                ...
                <div className="ml-2">{tokenAbalanceData?.symbol}</div>
              </div>
            </div>
      ...
      {ftoState == 2 ? (
        ...
        >
          ...
          {formatEther(allownedTokenToFTO || 0) == "0" ? "Approve" : `Deposit`}
        </button>
      ) : ftoState == 0 ? (
        // success
        <button
        ...
        <button
          ...
          ${ftoState == 2 ? "bg-indigo-400" : "bg-indigo-400"}
